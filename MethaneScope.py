...
/* =========================================================
   FINAL WIDGET COLOR FIXES
   ========================================================= */

/* ---------- DATE INPUT LABELS ---------- */
/* Start date / End date must be white */
.stDateInput label,
.stDateInput label *,
...
/* ---------- DATE INPUT VALUE ---------- */
/* Date value inside the dark field must remain white */
.stDateInput input,
...
/* ---------- COPERNICUS LOGIN INPUTS ---------- */
/* Email / Password / 2FA values must be white */
.stTextInput input,
...
/* ---------- TARGET SCENE SELECTBOX ---------- */
/* Selected Target scene value must be white */
...
/* Target scene selected field */
.stSelectbox [data-baseweb="select"],
div[data-testid="stSelectbox"] [data-baseweb="select"] {
    background-color: #111318 !important;
}

/* Target scene dropdown options */
div[data-baseweb="popover"] [role="listbox"],
div[data-baseweb="popover"] ul[role="listbox"] {
    background-color: #111318 !important;
}
...
/* Open Copernicus button: normal state */
...
/* Primary buttons remain red with white text */
button[kind="primary"],
.stButton button[kind="primary"],
...
/* ---------- BROWSER AUTOFILL ---------- */
/* Prevent browser autofill from turning text black */
.stTextInput input:-webkit-autofill,
.stTextInput input:-webkit-autofill:hover,
.stTextInput input:-webkit-autofill:focus,
.stDateInput input:-webkit-autofill,
.stDateInput input:-webkit-autofill:hover,
.stDateInput input:-webkit-autofill:focus {
    -webkit-text-fill-color: #ffffff !important;
    caret-color: #ffffff !important;
}
